...
<p class="pull-right">
<strong>
Fork me on <a href="https://github.com/christophergandrud/dpmr"><i class="fa fa-github fa-lg"></i></a>
</strong>
</p>

**Under Development: v`r packageVersion('dpmr')`**
...
<p class="pull-right">
<strong>
Issues/suggestions <a href="https://github.com/christophergandrud/dpmr/issues"><i class="fa fa-exclamation-circle"></i></a>
</strong>
</p>


**Maintainer:** [Christopher Gandrud](http://christophergandrud.blogspot.com/)

## Description

The R package for creating and installing data packages that follow the
[Open Knowledge's](https://okfn.org/)'s
[Tabular Data Package spec](http://data.okfn.org/doc/tabular-data-package/).
